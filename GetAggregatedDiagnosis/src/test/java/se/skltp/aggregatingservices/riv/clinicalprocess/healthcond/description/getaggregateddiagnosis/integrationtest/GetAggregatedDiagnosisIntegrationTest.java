	...
	protected String getConfigResources() {
		return 
			"soitoolkit-mule-jms-connector-activemq-embedded.xml," + 
	  		"GetAggregatedDiagnosis-common.xml," +
//          Only load GetAggregatedDiagnosis-common.xml, it will import the other config files since mule-deploy.properties can't load config-files from jar-files on the classpath, e.g. agp-core.jar
...
//	        "aggregating-service.xml," +
	...
	private List<ProcessingStatusRecordType> doTest(String registeredResidentId, String senderId, String originalConsumerHsaId, int expectedProcessingStatusSize, ExpectedTestData... testData) {
		...
		GetAggregatedDiagnosisTestConsumer consumer = new GetAggregatedDiagnosisTestConsumer(DEFAULT_SERVICE_ADDRESS, senderId ,originalConsumerHsaId);
