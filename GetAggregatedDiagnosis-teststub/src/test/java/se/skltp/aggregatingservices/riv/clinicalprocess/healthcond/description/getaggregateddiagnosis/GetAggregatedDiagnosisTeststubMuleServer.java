...
public class GetAggregatedDiagnosisTeststubMuleServer {


	public static final String MULE_SERVER_ID   = "GetAggregatedDiagnosis-teststub";
 

	private static final Logger logger = LoggerFactory.getLogger(GetAggregatedDiagnosisTeststubMuleServer.class);
