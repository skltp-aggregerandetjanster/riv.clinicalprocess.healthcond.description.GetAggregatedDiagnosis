...
import static se.skltp.aggregatingservices.riv.clinicalprocess.healthcond.description.getdiagnosis.v2.Producer.TOLVAN_TOLVANSSON
...
@WebService
public class Producer1 implements GetDiagnosisResponderInterface {
	...
	public GetDiagnosisResponseType getDiagnosis(
		...
		def createResult = {
			response.diagnosis.add(builder.createResponse(parameters, "HSAPRODUCER1"))
		}
